  ...
  return (
    <View style={styles.container}>
      ...
      <LocServiceNav
        ...
        activeService="BoardingServices"
      />
      <Divider/>
      <View style={styles.sectionContainer}>
        <View style={styles.containerTitle}>
          <Text style={styles.sectionTitle}>Nearby Boardings</Text>
          <TouchableOpacity
            onPress={() => {
      ...
      <View style={styles.sectionContainer}>
        <View style={styles.containerTitle}>
          <Text style={styles.sectionTitle}>Recommended Boardings</Text>
          <TouchableOpacity
            onPress={() => {
        ...
        {recommendedBoardings.map((service) => (
          <ServiceCard
            key={service.id}
            service={service}
            onPress={() => {
