...
namespace SeniorProject.V2.Controllers
{
    ...
    public class ShelterController : ControllerBase
    {
        ...
        [HttpPost("AddShelter")]
        public async Task<IActionResult> AddShelter([FromBody] AddingShelterDto addingShelter)
        {
        ...
        public async Task<IActionResult> UpdateShelter([FromForm] UpdateShelterDto shelter)
        {
            ...
            updatedShelter.PermitNumber = string.IsNullOrEmpty(shelter.ZipCode) ? updatedShelter.PermitNumber : shelter.ZipCode;
            updatedShelter.WebsiteUrl = string.IsNullOrEmpty(shelter.WebsiteUrl) ? updatedShelter.WebsiteUrl : shelter.WebsiteUrl;
            updatedShelter.RepPhone = string.IsNullOrEmpty(shelter.AdditionalInformation) ? updatedShelter.RepPhone : shelter.AdditionalInformation;
